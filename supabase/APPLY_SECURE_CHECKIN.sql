-- Run once in Supabase SQL Editor (https://supabase.com/dashboard/project/osrojmqhmonsxgbbyghg/sql/new)
-- Applies migrations 005 + 006 + 007 (anti-cheat + face match + video liveness + security)
...
-- Migration 008: granular security toggles + checkout verification
